...
pub mod client {
    ...
    pub use client_conn::{
        ClientConfig, ClientConnectionData, ClientHelloFingerprintProfile, ClientSessionStore,
        EarlyDataError, ResolvesClientCert, RealitySessionIdGenerator, Resumption,
